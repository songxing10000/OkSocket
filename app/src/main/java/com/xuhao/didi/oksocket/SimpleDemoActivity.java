...
public class SimpleDemoActivity extends AppCompatActivity {
    ...
    private Button mMaoBtn;

    private  Button mMao1Btn;
    private Button mMao2Btn;
    ...
    private void findViews() {
        ...
        mLightBtn = findViewById(R.id.button_light);
        mLightOffBtn = findViewById(R.id.button_off);
        mMaoBtn = findViewById(R.id.button_mao);
        mMao1Btn = findViewById(R.id.button_mao1);

        mMao2Btn = findViewById(R.id.button_mao2);
    ...
    private void setListener() {
        ...
        mLightBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!mManager.isConnect()) {
                    ...
                    MsgDataBean msgDataBean = new MsgDataBean("开灯");
                    mManager.send(msgDataBean);
        ...
        mLightOffBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MsgDataBean msgDataBean = new MsgDataBean("关灯");
                mManager.send(msgDataBean);


            }
        });
        mMaoBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mManager == null) {
                    return;
                ...
                MsgDataBean msgDataBean = new MsgDataBean("猫");
                mManager.send(msgDataBean);


            }
        });
        mMao1Btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mManager == null) {
                    return;
                ...
                MsgDataBean msgDataBean = new MsgDataBean("猫1");
                mManager.send(msgDataBean);


            }
        });
        mMao2Btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mManager == null) {
                    return;
                ...
                MsgDataBean msgDataBean = new MsgDataBean("猫2");
                mManager.send(msgDataBean);
